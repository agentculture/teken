...
See :mod:`teken.explain.catalog` for the string bodies and :func:`resolve` for
...
from teken.explain.catalog import ENTRIES
...
def resolve(path: tuple[str, ...]) -> str:
    ...
    raise AfiError(
        ...
        remediation="list known entries with: teken explain teken",
    )
